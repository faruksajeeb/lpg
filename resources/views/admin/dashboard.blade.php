...
<html lang="en-us">
    <head>
        ...
        <script>
            if (!window.jQuery) {
            document.write('<script src="{{asset('resources / assets')}}/admin/js/libs/jquery-2.1.1.min.js"><\/script>');
            }
        </script>
           <!-- JQUERY VALIDATE -->
    ...
    <body >
        ...
        <script data-pace-options='{ "restartOnRequestAfter": true }' src="{{asset('resources/assets')}}/admin/js/plugin/pace/pace.min.js"></script>
        ...
        <script>
            if (!window.jQuery.ui) {
            document.write('<script src="{{asset('resources / assets')}}/admin/js/libs/jquery-ui-1.10.3.min.js"><\/script>');
            }
        </script>
        ...
        <!-- CUSTOM NOTIFICATION -->
        <script src="{{asset('resources/assets')}}/admin/js/notification/SmartNotification.min.js"></script>

        <!-- JARVIS WIDGETS -->
        <script src="{{asset('resources/assets')}}/admin/js/smartwidgets/jarvis.widget.min.js"></script>

        <!-- EASY PIE CHARTS -->
        <script src="{{asset('resources/assets')}}/admin/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>

        <!-- SPARKLINES -->
        <script src="{{asset('resources/assets')}}/admin/js/plugin/sparkline/jquery.sparkline.min.js"></script>
        ...
        <script src="{{asset('resources/assets')}}/admin/js/plugin/select2/select2.min.js"></script>

        <!-- JQUERY UI + Bootstrap Slider -->
        <script src="{{asset('resources/assets')}}/admin/js/plugin/bootstrap-slider/bootstrap-slider.min.js"></script>

        <!-- browser msie issue fix -->
        <script src="{{asset('resources/assets')}}/admin/js/plugin/msie-fix/jquery.mb.browser.min.js"></script>

        <!-- FastClick: For mobile devices -->
        <script src="{{asset('resources/assets')}}/admin/js/plugin/fastclick/fastclick.min.js"></script>
        ...
        <!-- Demo purpose only -->
        <script src="{{asset('resources/assets')}}/admin/js/demo.min.js"></script>
        ...
        <script src="{{asset('resources/assets')}}/admin/js/speech/voicecommand.min.js"></script>

        <!-- SmartChat UI : plugin -->
        <script src="{{asset('resources/assets')}}/admin/js/smart-chat-ui/smart.chat.ui.min.js"></script>
        <script src="{{asset('resources/assets')}}/admin/js/smart-chat-ui/smart.chat.manager.min.js"></script>

        <!-- PAGE RELATED PLUGIN(S) -->

        <!-- Flot Chart Plugin: Flot Engine, Flot Resizer, Flot Tooltip -->
        <script src="{{asset('resources/assets')}}/admin/js/plugin/flot/jquery.flot.cust.min.js"></script>
        <script src="{{asset('resources/assets')}}/admin/js/plugin/flot/jquery.flot.resize.min.js"></script>
        <script src="{{asset('resources/assets')}}/admin/js/plugin/flot/jquery.flot.time.min.js"></script>
        <script src="{{asset('resources/assets')}}/admin/js/plugin/flot/jquery.flot.tooltip.min.js"></script>

        <!-- Vector Maps Plugin: Vectormap engine, Vectormap language -->
        <script src="{{asset('resources/assets')}}/admin/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="{{asset('resources/assets')}}/admin/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script>

        <!-- Full Calendar -->
        <script src="{{asset('resources/assets')}}/admin/js/plugin/moment/moment.min.js"></script>
        <script src="{{asset('resources/assets')}}/admin/js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script>
